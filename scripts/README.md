...
| `generate_bootstrap_prompt.py` | Prompt Architect: turns English intent into a structured Gemini session bootstrap prompt. |
| `update_getting_started.py` | Auto-updates GEMINI_Getting_Started.md via the Gemini API. |
